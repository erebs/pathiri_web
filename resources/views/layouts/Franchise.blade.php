...
<head>
  ...
  <!-- PAGE TITLE HERE -->
  <title>Franchise | @yield('title')</title>
    ...
    ***********************************-->
    ...
    <!--**********************************
                      ...
                      <li>
                        <div class="timeline-panel">
                          ...
                          <div class="media-body">
                            ...
                            <li class="nav-item">
                <a href="/franchise/add-shop" class="btn btn-primary d-sm-inline-block d-none"> <i class="fa fa-plus-circle"></i>&nbsp    Add Shop</a>
              </li>
                        </ul>
                    </div>
        </nav>
        ...
        ***********************************-->
        ...
        <ul class="metismenu" id="menu">
          <li class="dropdown header-profile">
            <a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
                @if(Auth::guard('franchise')->user()->profile_image=='')
                <img src="{{ asset('admin/img/default.jpg')}}" width="20" alt="">
                @else
              <img src="{{ asset('admin/img/'.Auth::guard('franchise')->user()->profile_image)}}" width="20" alt="">
              @endif
              <div class="header-info ms-3">
                <span class="font-w600 " style="color: white !important;">Hi,<b>   {{Auth::guard('franchise')->user()->name}}</b></span>
                <small class="text-end font-w400">Franchise</small>
              </div>
            </a>
            <div class="dropdown-menu dropdown-menu-end">
              <a href="/franchise/edit-profile" class="dropdown-item ai-icon">
                <svg id="icon-user1" xmlns="http://www.w3.org/2000/svg" class="text-primary" width="18" height="18" viewbox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                <span class="ms-2">Edit Profile </span>
              </a>
              
              <a href="/franchise/logout" class="dropdown-item ai-icon">
                ...
                <span class="ms-2">Logout </span>
                    ...
                    <li><a href="/franchise/dashboard" class="ai-icon" aria-expanded="false">
                        <i class="flaticon-025-dashboard"></i>
                        <span class="nav-text">Dashboard</span>
                    </a>
                </li>

                 <!-- <li><a href="/franchise/add-shop" class="ai-icon" aria-expanded="false">
              ...
              <span class="nav-text">Shops</span>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/franchise/active-shops">Active</a></li>
                            <li><a href="/franchise/blocked-shops">Blocked</a></li>
                        </ul>
                    </li>

                 <li><a href="/franchise/add-staff" class="ai-icon" aria-expanded="false">
                        <i class="fa fa-user-plus"></i>
                        <span class="nav-text">Add Delivery Staffs</span>
                    </a>
                </li>
              ...
              <span class="nav-text">Delivery Staffs</span>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/franchise/active-staff">Active</a></li>
                            <li><a href="/franchise/blocked-staff">Blocked</a></li>
                        </ul>
                    </li>
              ...
              <span class="nav-text">Reports</span>
                ...
                <ul aria-expanded="false">
                    <li><a href="/franchise/change-password">Change Password</a></li>
                    <!-- <li><a href="chart-flot.html">Sleep</a></li> -->
                    <li><a href="/franchise/logout">Logout</a></li>
                </ul>
            </li>
        ...
        <div class="copyright">
          <p><strong>Franchise Dashboard</strong> © 2023 All Rights Reserved</p>
