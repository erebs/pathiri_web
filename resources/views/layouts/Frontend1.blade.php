...
<body>
		<div class="container-main">
			<div class="headers">
				<div class="logo-navbar">
					<a href="/restaurents"><img class="logo-nav" src="{{asset('/frontend/images/Millennium_logo.png')}}" style="width:100px;" alt=""></a>
				</div>
				<div class="item-navs">
					<ul class="mb-0">
						<li class="text-white item-nav"><a href="/restaurents">Home</a></li>
						<li class="text-white item-nav"><a href="/restaurents/about">About Us</a></li>
						<li class="text-white item-nav"><a href="/restaurents/menu">Menu</a></li>
						<li class="text-white item-nav"><a href="/restaurents/gallery">Gallery</a></li>
						<li class="text-white item-nav"><a href="/restaurents/contact">Contact Us</a></li>
		...
		<div class="sidebar">
			<div class="navbar-sidebar">
				<ul>
					<li><a class="active" href="/restaurents">Home</a></li>
							<li><a class="active" href="/restaurents/menu">Menu</a></li>    
							<li><a class="active" href="/restaurents/about">About Us</a></li>    
							<li><a class="active" href="/restaurents/gallery">Gallery</a></li>  
							<li><a class="active" href="/restaurents/contact">Contact Us</a></li>  
			...
			<div class="modal-body modal-loginform pt-0">
				<div class="form-menu-table">
					...
					<div class="img-select">
						...
						@foreach($rest as $rt)
						@if($rt->id==1)
						<div class="image-container" id="image2-container" style="cursor:pointer;" onclick="window.location.href='/'">
							<img id="image2" src="{{asset('uploads/shop/'.$rt->profile_image)}}" alt="Image 1">
			...
			<div style="background: #000000 ;width: 100%;border-radius: 10px;margin: auto;padding: 10px;" class="modal-content login-modal-home-p">
				...
				<div class="modal-body modal-loginform pt-0">
					<div class="form-menu-table">
						...
						<form>
							<div class="form-group">
								<input class="date" type="date" id="bdate">							</div>
						</form>
						<form>
							<div class="form-group">
				...
				<div class="row">
					<div class="col-lg-3 col-md-6">
						<div class="footer-main-box">
							<img class="logo-footer" src="{{asset('/frontend/images/Millennium_logo.png')}}" alt="" style="width:120px;">
					...
					<div class="col-lg-3 col-md-6">
						<div class="footer-main-box">
							...
							<ul>
								<li class="mb-0 footer-list"><a href="/restaurents/contact" style="color:white;">Contact Us</a></li>
								<li class="mb-0 footer-list"><a href="/restaurents/menu" style="color:white;">Menu</a></li>
								<li class="mb-0 footer-list"><a href="/restaurents/about" style="color:white;">About Us</a></li>
								<li class="mb-0 footer-list"><a href="/restaurents/gallery" style="color:white;">Gallery</a></li>
								<li class="mb-0 footer-list"><a href="/restaurents" style="color:white;">Home</a></li>
							</ul>
						</div>
					</div>
					<div class="col-lg-3 col-md-6">
						<div class="footer-main-box">
							...
							<ul>
								@php
						$rest1=DB::table('shops')->where('id',2)->first();
						@endphp
