...
@section('title')
 Gallery
  @endsection
  @section('head1') Gallery @endsection
@section('contents')
        ...
        <div class="content-body">
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    ...
                    <div class="col-lg-4">
                    <button type="button" class="btn btn-primary" onclick="AddOffer()" id="ab1">Add Image</button>
                    <button type="button" class="btn btn-primary" id="ab2"> <i class="fa fa-spinner fa-spin"></i>   Add Image</button>
                </div>
                </div>
