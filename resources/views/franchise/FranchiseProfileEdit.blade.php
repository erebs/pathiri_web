                                ...
                                <div class="basic-form">
                                    <form>
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" placeholder="Enter name" id="cname" value="{{$franchise->name}}">
                                            </div>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" placeholder="Enter mobile number" id="cmobile" value="{{$franchise->mobile}}" readonly>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" placeholder="Enter mail id" id="cmail" value="{{$franchise->mail_id}}">
                                            </div>
