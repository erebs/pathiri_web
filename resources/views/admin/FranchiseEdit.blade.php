...
@section('title')
 franchise
  @endsection
      @section('head1') Edit Franchise @endsection
@section('contents')
                                        ...
                                        <div class="row">
                                            <div class="col-xl-6">
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-lg-6">
														<input type="text" class="form-control" placeholder="Enter name" id="name" value="{{$franchise->name}}">
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-lg-6">
														<input type="number" class="form-control" placeholder="Enter mobile number" id="mobile" value="{{$franchise->mobile}}">
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="email" class="form-control" placeholder="Enter Mail id" id="mail" value="{{$franchise->mail_id}}">
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <textarea class="form-control"  rows="5" placeholder="Enter Details" id="det">{{$franchise->details}}</textarea>
...
type:"POST",
url:"/administrator/franchise-edit",
data:data,
dataType:"json",
contentType: false,
//cache: false,
...
success:function(data)
{
  if(data['success'])
  {
    ...
    $('#ab1').show();
            Toastify({
              text: "Franchise updated successfully",
              duration: 1000,
              newWindow: true,
              // close: true,
...
type:"POST",
url:"/administrator/franchise-psw-update",
data:data,
dataType:"json",
contentType: false,
//cache: false,
...
success:function(data)
{
  if(data['success'])
  {
    ...
    $('#ab3').show();
            Toastify({
              text: "Franchise password changed successfully",
              duration: 1000,
              newWindow: true,
              // close: true,
              gravity: "bottom", // `top` or `bottom`
