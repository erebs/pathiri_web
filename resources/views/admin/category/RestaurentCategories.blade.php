...
@section('title')
 Categories
  @endsection
  @section('head1') Restaurent Categories @endsection
@section('contents')
					...
					<div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Restaurent Categories</h4>
                                <a href="/administrator/add-rcategory" class="btn btn-primary d-sm-inline-block d-none">Add New</a>
                            </div>
                            <div class="card-body">
                                                ...
                                                <td>
													...
													<div class="dropdown ms-auto text-end">
														...
														<div class="dropdown-menu dropdown-menu-end">
															...
															<a class="dropdown-item" href="/administrator/edit-rcategory/{{encrypt($f->id)}}">Edit Category</a>
                                                            @if($f->status=='Active')
...
function RejectUser()
    {
      ...
      $.ajax({
        ...
        type:"POST",
        url:"/administrator/block-rcategory",
         data: data,
        dataType:"json",
        contentType: false,
//cache: false,
...
$.ajax({
              ...
              type:"POST",
              url:'/administrator/activate-rcategory',
              data: {
